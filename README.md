...
Microsoft Entra (Azure AD) related scripts and tools

## Overview

This repository contains PowerShell scripts and tools for managing Microsoft Entra (formerly Azure Active Directory) environments.
...
```bash
git clone https://github.com/aollivierre/Entra.git
cd Entra
```
